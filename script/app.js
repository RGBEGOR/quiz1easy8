...
[
	...
	new Question("Давайте кратко по командам продолжим предложение: На прошлой неделе я узнал/а… и научился/ась", 
	[
		new Answer("поехали дальше", 1)
	]),
	new Question("Как Вы понимаете, что же такое рефлексия", 
	[
		new Answer('результаты собственной деятельности', 0),
		new Answer("Проверка себя", 0),
		new Answer("Оценка себя", 0),
		new Answer("Все ответы верны", 1)
	]),
	new Question("Какие из заданий в MS Teams для Вас оказались слишком трудными и почему ", 
	[
		new Answer("далее", 1)
	]),
	new Question("А какие задания для Вас показались самыми увлекательными😃", 
	[
		new Answer("далее", 1),
	]),
	new Question("Как Вы считаете что очень Важно при выполнении любого задания и уроков в онлайн школе?", 
	[
		new Answer('Правильно выполнять задания', 0),
		new Answer("ВОВРЕМЯ отправлять задания", 0),
		new Answer("Активно участвовать на вебинарных занятиях", 0),
		new Answer("Все ответы верны", 1)
	]),
